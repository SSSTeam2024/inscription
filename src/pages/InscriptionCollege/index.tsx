...
import { useAddNewInscriptionMutation } from "features/inscriptions/inscriptionSlice";
                  ...
                  <tbody>
                    ...
                    <td>
                      <input
                        ...
                        className="form-control"
                        onChange={onChangeInscription}
                        value={inscriptionData.moyenne_concours_6}
                      />
                    </td>
                  </tbody>
                </table>
...
export default InscriptionCollege;
